/**
 * One-off iOS-26-aesthetic wallpaper generator for SongScribe Tuner marketing.
 *
 * Generates 3 abstract, non-infringing wallpaper variants via Hedra Nano Banana
 * Pro T2I at 9:16 / 4K, writes them to a configured output dir. Original
 * compositions — intentionally unlike Apple's stock iOS 26 wallpapers.
 *
 * Run:  npx tsx src/generate-wallpaper.ts
 */
...
const SIZE = '2160x3840'; // 9:16 portrait, 4K long edge
const NEGATIVE = [
  'text',
  'logo',
  'watermark',
...
const STYLE_BASE = [
  'Tall portrait 9:16 phone wallpaper composition.',
...
const VARIANTS: Array<{ id: string; seed: number; prompt: string }> = [
  {
    id: 'wallpaper-01-parchment-amber',
    seed: 481273,
    prompt: [
      STYLE_BASE,
  ...
  {
    id: 'wallpaper-02-midnight-amber',
    seed: 729104,
    prompt: [
      STYLE_BASE,
  ...
  {
    id: 'wallpaper-03-parchment-teal',
    seed: 315042,
    prompt: [
      STYLE_BASE,
